class User < ApplicationRecord
  ...
  def self.get_pre_image_texts(num)
    if num == 0
      ...
      return ["The weather is what is. Neither good or bad. We know what you're thinking:", "So to add a little excitement to your day, we're sending you a discount. Hooray!"]
    end
  end
